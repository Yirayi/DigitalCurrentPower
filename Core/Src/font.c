...
const uint8_t minzh[][36] = {};
const Font minfont = {8, 6, (const uint8_t *)minzh, 4, &afont8x6};

const uint8_t mediumzh[][36] = {};
const Font mediumfont = {12, 6, (const uint8_t *)mediumzh, 4, &afont12x6};
// 8*6 ASCII
